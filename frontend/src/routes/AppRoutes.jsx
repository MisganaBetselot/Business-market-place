    ...
    children: [
      ...
      // pages go in ITS children array, not as a React children prop.
      {
        ...
        children: [
          ...
          // sell/receipt intentionally removed — ReceiptUpload.jsx's
          // functionality was fully merged into PaymentInstructions.jsx
          // (payment details + receipt upload now live on one page).
